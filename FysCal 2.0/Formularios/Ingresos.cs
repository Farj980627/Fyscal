    ...
    public partial class Ingresos : Form
    {
        ...
        {   
            ...
            */
            ...
            /*
                 //Ajustando Columnas
                 label16.Text = "Ventas Al Publico";
                 //Cambiando Colo por Bimestres
                 txtEne0.BackColor = Color.Black;
                 txtEne16.BackColor = Color.Black;
                 txtEneAcu.BackColor = Color.Black;
                 txtEneExe.BackColor = Color.Black;
                 txtEneNoo.BackColor = Color.Black;
                 txtEneIMes.BackColor = Color.Black;
                 txtFeb0.BackColor = Color.Black;
                 txtFeb16.BackColor = Color.Black;
                 txtFebAcu.BackColor = Color.Black;
                 txtFebExe.BackColor = Color.Black;
                 txtFebNoo.BackColor = Color.Black;
                 txtFebIMes.BackColor = Color.Black;
                 txtMay0.BackColor = Color.Black;
                 txtMay16.BackColor = Color.Black;
                 txtMayAcu.BackColor = Color.Black;
                 txtMayExe.BackColor = Color.Black;
                 txtMayNoo.BackColor = Color.Black;
                 txtMayIMes.BackColor = Color.Black;
                 txtJun0.BackColor = Color.Black;
                 txtJun16.BackColor = Color.Black;
                 txtJunAcu.BackColor = Color.Black;
                 txtJunExe.BackColor = Color.Black;
                 txtJunNoo.BackColor = Color.Black;
                 txtJunIMes.BackColor = Color.Black;
                 txtSep0.BackColor = Color.Black;
                 txtSep16.BackColor = Color.Black;
                 txtSepAcu.BackColor = Color.Black;
                 txtSepExe.BackColor = Color.Black;
                 txtSepNoo.BackColor = Color.Black;
                 txtSepIMes.BackColor = Color.Black;
                 txtOct0.BackColor = Color.Black;
                 txtOct16.BackColor = Color.Black;
                 txtOctAcu.BackColor = Color.Black;
                 txtOctExe.BackColor = Color.Black;
                 txtOctNoo.BackColor = Color.Black;
                 txtOctIMes.BackColor = Color.Black;

                 //Actualizando Etiquetas :3
                 label3.Hide();
                 label2.Text = "1er BIMESTRE";                
                 label5.Hide();
                 label4.Text = "2do BIMESTRE";
                 label7.Hide();
                 label6.Text = "3er BIMESTRE";
                 label9.Hide();
                 label8.Text = "4to BIMESTRE";
                 label11.Hide();
                 label10.Text = "5to BIMESTRE";
                 label13.Hide();
                 label12.Text = "6to BIMESTRE";
                 label17.Text = "Ingreso Bimestral";
                 ...
                 //Calcular lo acumulado bimestre
                 txtFebAcu.Text = (double.Parse(txtEne16.Text) + double.Parse(txtEne0.Text) + double.Parse(txtEneExe.Text) + double.Parse(txtEneNoo.Text) + double.Parse(txtFeb16.Text) + double.Parse(txtFeb0.Text) + double.Parse(txtFebExe.Text) + double.Parse(txtFebNoo.Text)).ToString();

                 txtAbrAcu.Text = (double.Parse(txtMar16.Text) + double.Parse(txtMar0.Text) + double.Parse(txtMarExe.Text) + double.Parse(txtMarNoo.Text) + double.Parse(txtAbr16.Text) + double.Parse(txtAbr0.Text) + double.Parse(txtAbrExe.Text) + double.Parse(txtAbrNoo.Text)).ToString();

                 txtJunAcu.Text = (double.Parse(txtMay16.Text) + double.Parse(txtMay0.Text) + double.Parse(txtMayExe.Text) + double.Parse(txtMayNoo.Text) + double.Parse(txtJun16.Text) + double.Parse(txtJun0.Text) + double.Parse(txtJunExe.Text) + double.Parse(txtJunNoo.Text)).ToString();

                 txtAgoAcu.Text = (double.Parse(txtJul16.Text) + double.Parse(txtJul0.Text) + double.Parse(txtJulExe.Text) + double.Parse(txtJulNoo.Text) + double.Parse(txtAgo16.Text) + double.Parse(txtAgo0.Text) + double.Parse(txtAgoExe.Text) + double.Parse(txtAgoNoo.Text)).ToString();

                 txtOctAcu.Text = (double.Parse(txtSep16.Text) + double.Parse(txtSep0.Text) + double.Parse(txtSepExe.Text) + double.Parse(txtSepNoo.Text) + double.Parse(txtOct16.Text) + double.Parse(txtOct0.Text) + double.Parse(txtOctExe.Text) + double.Parse(txtOctNoo.Text)).ToString();

                 txtDicAcu.Text = (double.Parse(txtNov16.Text) + double.Parse(txtNov0.Text) + double.Parse(txtNovExe.Text) + double.Parse(txtNovNoo.Text) + double.Parse(txtDic16.Text) + double.Parse(txtDic0.Text) + double.Parse(txtDicExe.Text) + double.Parse(txtDicNoo.Text)).ToString();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            Clases.conexiones.ingresosExentos(Formularios.Control.idCliente, txtEneExe.Text, txtFebExe.Text, txtMarExe.Text, txtAbrExe.Text, txtMayExe.Text, txtJunExe.Text,
            ...
            Clases.conexiones.ingTotalesMes(Formularios.Control.idCliente, txtEneIMes.Text, txtFebIMes.Text, txtMarIMes.Text, txtAbrIMes.Text, txtMayIMes.Text, txtJunIMes.Text, txtJulIMes.Text,
                txtAgoIMes.Text, txtSepIMes.Text, txtOctIMes.Text, txtNovIMes.Text, txtDicIMes.Text);

            Clases.conexiones.ingAcumulados(Formularios.Control.idCliente, txtEneAcu.Text, txtFebAcu.Text, txtMarAcu.Text, txtAbrAcu.Text, txtMayAcu.Text, txtJunAcu.Text, txtJulAcu.Text,
        ...
        private void txtFebNoo_TextChanged(object sender, EventArgs e)
        {
            ...
            double totFeb = double.Parse(txtFeb16.Text) + double.Parse(txtFeb0.Text) + double.Parse(txtFebExe.Text) + double.Parse(txtFebNoo.Text);
            txtFebIMes.Text = totFeb.ToString();
            //Haciendo suma de acumulados en TIEMPO REAL (ACT EMP)
        ...
        private void txtDicIMes_TextChanged(object sender, EventArgs e)
        {
            //Calculando total de cada ingreso --Mes
            double totIIMes = double.Parse(txtEneIMes.Text) + double.Parse(txtFebIMes.Text) + double.Parse(txtMarIMes.Text) + double.Parse(txtAbrIMes.Text) + double.Parse(txtMayIMes.Text) +
            +double.Parse(txtJunIMes.Text) + double.Parse(txtJulIMes.Text) + double.Parse(txtAgoIMes.Text) + double.Parse(txtSepIMes.Text) + double.Parse(txtOctIMes.Text) +
        ...
        private void txtEneRetISR_Leave(object sender, EventArgs e)
        {
            //Calculando total de cada ingreso --Retenciones ISR
            txtTotRetISR.Text = (double.Parse(txtEneRetISR.Text) + double.Parse(txtFebRetISR.Text) + double.Parse(txtMarRetISR.Text) + double.Parse(txtAbrRetISR.Text) + double.Parse(txtMayRetISR.Text) +
            +double.Parse(txtJunRetISR.Text) + double.Parse(txtJulRetISR.Text) + double.Parse(txtAgoRetISR.Text) + double.Parse(txtSepRetISR.Text) + double.Parse(txtOctRetISR.Text) +
            double.Parse(txtNovRetISR.Text) + double.Parse(txtDicRetISR.Text)).ToString();
        }

        private void txtEneRetIVA_Leave(object sender, EventArgs e)
        {
            //Calculando total de cada ingreso --Retenciones IVA
            txtTotRetIVA.Text = (double.Parse(txtEneRetIVA.Text) + double.Parse(txtFebRetIVA.Text) + double.Parse(txtMarRetIVA.Text) + double.Parse(txtAbrRetIVA.Text) + double.Parse(txtMayRetIVA.Text) +
            +double.Parse(txtJunRetIVA.Text) + double.Parse(txtJulRetIVA.Text) + double.Parse(txtAgoRetIVA.Text) + double.Parse(txtSepRetIVA.Text) + double.Parse(txtOctRetIVA.Text) +
            double.Parse(txtNovRetIVA.Text) + double.Parse(txtDicRetIVA.Text)).ToString();
        }
    }
}
