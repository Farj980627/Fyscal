...
namespace FysCal_2._0.Formularios
{
    public partial class calculoGeneral : Form
    {
        ...
        double[] enero = new double[] { 0.01, 578.53, 4910.19, 8629.21, 10031.08, 12009.95, 24222.32, 38177.70, 72887.51, 97183.34, 291550.01 };
        double[] cuotaenero = new double[] { 0.0, 11.11, 288.33, 692.96, 917.26, 1271.87, 3880.44, 7162.74, 17575.69, 25350.35, 91435.02 };
        double[] porcentajeenero = new double[] { 1.92, 6.40, 10.88, 16.00, 17.92, 21.36, 23.52, 30.00, 32.00, 34.00, 35.00 };

        double[] febrero = new double[] { 0.01, 1157.05, 9820.37, 17258.41,20062.15, 24019.89, 48444.63, 76355.39, 145775.01, 1943666.67, 583100.01 };
        double[] cuotafeb = new double[] { 0.00, 22.22, 576.66, 1385.92, 1834.52, 2543.74, 7760.88, 14325.48, 35151.38, 50700.70, 182870.04 };

        double[] marzo = new double[] { 0.01, 1735.57, 14730.55, 25887.61, 30093.22, 36029.83, 72666.94, 114533.08, 218662.51, 291550.00, 874650.01 };
        double[] cuotamar = new double[] { 33.33, 864.99, 2078.88, 2751.78, 3815.61, 11641.32, 21488.22, 52727.07, 76051.05, 274305.06 };

        double[] abril = new double[] { 0.01, 2314.09, 19640.73, 34516.81, 40124.29, 48039.77, 96889.25, 152710.77, 291550.01, 388733.33, 1166200.01 };
        double[] cuotaabr = new double[] { 0.00, 44.44, 1153.32, 2771.84, 3669.04, 5087.48, 15521.76, 28650.96, 70302.76, 101401.40, 365740.08 };

        double[] mayo = new double[] { 0.01, 2892.61, 24550.91, 43146.01, 50155.36, 60049.71, 121111.56, 190888.46, 364437.51, 485916.66, 1457750.01 };
        double[] cuotamay = new double[] { 0.00, 55.55, 1441.65, 3464.80, 4586.30, 6359.35, 19402.20, 35813.70, 87878.45, 126751.75, 457175.10 };

        double[] junio = new double[] { 0.01, 3471.13, 29461.09, 51775.21, 60186.43, 72059.65, 145333.87, 229066.15, 437325.01, 583099.99, 1749300.01 };
        double[] cuotajun = new double[] {0.00, 66.66, 1729.98, 4157.76, 5503.56, 7631.22, 23282.64, 42976.44, 105454.14, 152102.10, 548610.12 };

        double[] julio = new double[] { 0.01,4049.65, 34371.27, 60404.41, 70217.50, 84069.59, 169556.18, 267243.84, 510212.51, 680283.32, 2040850.01 };
        double[] cuotajul = new double[] { 0.00, 77.77, 2018.31, 4850.72, 6420.82, 8903.09, 27163.08, 50139.18, 123029.83, 640045.14 };

        double[] agosto = new double[] {0.01, 4628.17, 39281.45, 69033.61, 80248.57, 96079.53, 193778.49, 305421.53, 583100.01, 777466.65, 2332400.01 };
        double[] cuotaago = new double[] { 0.00, 88.88, 2306.64, 5543.68, 7338.08, 10174.96, 31043.52, 57301.92, 140605.52, 202802.80, 731480.16 };

        double[] septiembre = new double[] { 0.01, 5206.69, 44191.63, 77662.81, 90279.64, 108089.47, 218000.80, 343599.22, 655987.51, 874649.98, 2623950.01 };
        double[] cuotasep = new double[] { 0.00, 99.99, 2594.97, 6236.64, 8255.34, 11446.83, 34923.96, 64464.66, 158181.21, 228153.15, 822915.18 };

        double[] octubre = new double[] { 0.01, 5785.21, 49101.81, 86292.01, 100310.71, 120099.41, 242223.11, 381776.91, 728875.01, 971833.31, 2915500.01};
        double[] cuotaoct = new double[] { 0.00, 111.10, 2883.30, 6929.60, 9172.60, 12718.70, 38804.40, 71627.40, 175756.90, 253503.50, 914350.20 };

        double[] noviembre = new double[] { 0.01, 6363.73, 54011.99, 94921.21, 110341.78, 132109.35, 266445.42, 419954.60, 801762.51, 1069016.64, 3207050.01 };
        double[] cuotanov = new double[] { 0.00, 122.21, 3171.63, 7622.56, 10089.86, 13990.57, 42684.84, 78790.14, 193332.59, 278853.85, 1005785.22 };

        double[] diciembre = new double[] { 0.01, 6942.25, 58922.17, 103550.41, 120372.85, 144119.29, 290667.73, 458132.29, 874650.01, 1166200.01, 3498600.01 };
        double[] cuotadic = new double[] { 0.00, 133.37, 3459.99, 8315.48, 11007.11, 15262.49, 46565.29, 85952.89, 210908.30, 304204.17, 1097220.29 };
        ...
        private void cbMes_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtIVACargo.Text = (double.Parse(txtIVAFavor.Text) + double.Parse(txtIVACargo.Text)).ToString();
